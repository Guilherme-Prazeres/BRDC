...
# Constantes referentes a distancia do homepoint para a base
HOMEX = 0 
HOMEY = 0
HOMEZ = -10
...
def calculateMoves(dots):
    ...
    moves.insert(0, (HOMEX, HOMEY, HOMEZ-ZHOPHEIGHT)) #Adiciona a movimentacao para o ponto inicial ao inicio    
...
dots_3d.insert(0, (x_coords[0], y_coords[0], z_coords[0]+ ZHOPHEIGHT))
